...
Download the repo [1] from GitHub, and open the `shiny/hello_world/ui.r` and `shiny/hello_world/server.r` files in RStudio. Then click on "Run App" in the top-right corner of the source panel, or execute
...
... that is not covered today, but you should be aware of.
